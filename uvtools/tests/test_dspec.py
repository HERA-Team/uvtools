...
def test_dpss_operator(use_tensorflow):
    ...
    amat1, ncol1 = dspec.dpss_operator(freqs, [0.], [100e-9], eigenval_cutoff=[1e-9], use_tensorflow=use_tensorflow,
                                       lobe_ordering_like_scipy=True, tf_method="eigh_tridiagonal")
    ...
    amat1, ncol1 = dspec.dpss_operator(tarr, [0.], filter_half_widths, eigenval_cutoff=[1e-9], use_tensorflow=use_tensorflow,
                                       lobe_ordering_like_scipy=True, tf_method="eigh_tridiagonal")
